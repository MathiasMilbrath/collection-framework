public class Main {
    public static void main(String[] args) {
        ...
        dicionario.adicionarPalavra("A", "B");
        dicionario.adicionarPalavra("c", "d");
        dicionario.adicionarPalavra("e", "f");
        dicionario.adicionarPalavra("g", "h");

        dicionario.exibirPalavras();
        dicionario.pesquisarPorPalavra("e");
        dicionario.pesquisarPorPalavra("k");
        ...
        contagem.adicionarPalavra("a", 6);
        contagem.adicionarPalavra("b", 12);
        contagem.adicionarPalavra("c", 1);
        ...
        livrariaOnline.remocerLivro("1984");
    }
}